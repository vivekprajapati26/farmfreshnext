...
export default function LoginScreen() {
  ...
  return (
    <>
      ...
      <Layout  title = 'Create Account - farmfreshz.com Fresh veggies ,fruits, dairy products and many more'>
                  ...
                  <div className="lg:w-6/12 px-4 md:px-0">
                    <div className="md:p-12 md:mx-6">
                      ...
                      <form onSubmit = {handleSubmit(submitHandler)}>
                        <p className="mb-2 text-center  font-bold text-2xl text-green-900 ">Create Account</p>
                        ...
                        <div className="mb-4">
                          <input
                            ...
                            {...register('confirmPassword', {
                              ...
                              minLength:{value: 2 , message:' Confirm Password is more than 5 char'},
                            })}
                          ...
                          />
                          {errors.confirmpassword && errors.confirmPassword.type=== 'validate'&&(<div className='text-red-500 '>Passoword do not match  </div> )}
                        </div>
                        ...
                        <div className="text-center flex flex-col justify-center items-center pt-1 mb-12 pb-1">
                          <button type="submit"
                            ...
                            font-semibold text-sm leading-tight uppercase rounded bg-green-500 hover:bg-green-300 active:bg-green-50 w-72 mb-3 border-b-4 border-emerald-600 hover:border-emrald-800  ">SignUp </button>
