...
function OrderScreen() {
  ...
  return (
    <Layout title = {`Order ${orderId} farmfreshz.com Fresh veggies ,fruits, dairy products and many more`}>
      <h1 className = 'mb-4 text-xl'>{`Order ${orderId}`}</h1>
      {
        loading?( <div className=" text-red-600 text-xl">
          Loading....
        </div> ):
          ...
          {/* Payment method */}
            <div className="card bg-slate-200 p-5">
              ...
              <div>{paymentMethod}</div>
                {isPaid ? (
                  <div className="alert-sucess">Paid at {paidAt}</div>
                ) :(
            ...
            <div className="card  bg-slate-200 overflow-x-auto p-5 ">
